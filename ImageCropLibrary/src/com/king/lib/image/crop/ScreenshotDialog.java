...
import com.king.lib.image.crop.CropView.OnCropAreaChangeListener;
...
public class ScreenshotDialog extends Dialog implements android.view.View.OnClickListener
	 ...
	 */
	public ScreenshotDialog(Context context, OnCropListener listener) {
		...
		if (Build.VERSION.SDK_INT >= 21) {//android 5.0
			closeButton.setBackgroundResource(R.drawable.item_background_borderless_material);
			saveButton.setBackgroundResource(R.drawable.item_background_borderless_material);
			seizeButton.setBackgroundResource(R.drawable.item_background_borderless_material);
			undoButton.setBackgroundResource(R.drawable.item_background_borderless_material);
			cropAreaSizeButton.setBackgroundResource(R.drawable.item_background_borderless_material);
			cropFullScreenButton.setBackgroundResource(R.drawable.item_background_borderless_material);
			doneButton.setBackgroundResource(R.drawable.item_background_material);
	...
	private void saveCropBitmap() {
		if (onCropListener != null) {
			...
			onCropListener.onSaveCropBitmap(saveImage);
		}
	}
